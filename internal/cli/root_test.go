...
func TestParseGraphOutputFormats(t *testing.T) {
	tests := []struct {
		...
		{name: "format svg", args: []string{"--format", "svg", "symbol", "Answer"}, wantFormat: graphOutputSVG, wantArgs: []string{"symbol", "Answer"}},
		{name: "unsupported format", args: []string{"--format", "png", "symbol", "Answer"}, wantErr: true},
